...
{
    /// <summary>
    /// Calculate touch pinch and rotate.
    /// </summary>
    public class DetectTouchMovement : MonoBehaviour
    {
        ...
        /// <summary>
        /// Apply rotate and pinch (zoom) to a Game Object.
        /// You should use this function inside LateUpdate.
        /// </summary>
        ...
        public static void ApplyTo(GameObject target)
        {
            ...
            Vector3 targetScale = target.transform.localScale + Vector3.one * pinchAmount * 0.005f;
            if (targetScale.x > 2f) targetScale.x = targetScale.y = 2f;
            if (targetScale.x < 0.5f) targetScale.x = targetScale.y = 0.5f;
            ...
            target.transform.rotation = desiredRotation;
        }
    }
}